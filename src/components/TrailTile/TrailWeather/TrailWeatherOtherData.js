...
class TrailWeatherOtherData extends React.Component {
    ...
    render(props) {
        return (
            <div style={{display: 'inline-block', float: 'right', height: '100%', width: '80px'}}>
                ...
                <div className="weather-other-data-block" style={{display: 'block', height: '33px'}}>
                    ...
                    <div style={{display: "inline", fontSize: "12px"}}>{this.state.liveWeatherData.wind_speed} <b>mph {this.state.liveWeatherData.wind_direction}</b></div>
                </div>
            </div>
        );
    }
